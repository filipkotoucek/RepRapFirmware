...
# define FIRMWARE_NAME	"RepRapFirmware for Einsy"
# define DEFAULT_BOARD_TYPE BoardType::Einsy_20
...
#define HAS_CPU_TEMP_SENSOR		0		//samg55 does not have temp sensor inside chip
#define HAS_HIGH_SPEED_SD		0		//currently used only to print through USB
#define HAS_SMART_DRIVERS		1
#define HAS_STALL_DETECT		1		//tmc2660 has stall detection TODO: tmc2130 to be implemented
#define HAS_VOLTAGE_MONITOR		1		//can be used for powerpanic. Not sure if its implemented as interrupt or simple pooling
...
constexpr Pin SdCardDetectPins[NumSdCards] = {53};
